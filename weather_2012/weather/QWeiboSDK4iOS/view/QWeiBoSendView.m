...
@interface QWeiboSendView (Private)
...
@implementation QWeiboSendView

@synthesize contentText;
@synthesize contentImage;
@synthesize delegate;

#pragma mark - QWeiboSendView Life Circle

- (id)initWithAppKey:(NSString *)appKey appSecret:(NSString *)appSecret text:(NSString *)text image:(UIImage *)image
{
    if (self = [super initWithFrame:CGRectMake(0, 0, 320, 361)])
    {
...
//        [engine setDelegate:self];
        ...
        // add the panel view
        panelView = [[UIView alloc] initWithFrame:CGRectMake(16, 43, 288, 335)];
...
#pragma mark - QWeiboSendView Private Methods
...
- (void)onSendButtonTouched:(id)sender
{
    ...
    [delegate sendQWeiboWithText:contentTextView.text image:contentImage SendView:self];
}
...
- (void)sizeToFitOrientation:(UIInterfaceOrientation)orientation
{
    ...
    {
        [self setFrame:CGRectMake(0, 0, 361, 320)];
        [panelView setFrame:CGRectMake(16, 10, 361 - 32, 280)];
        [contentTextView setFrame:CGRectMake(13, 50, 361 - 32 - 26, 60 + 50)];
        ...
        [panelImageView setFrame:CGRectMake(0, 0, 361 - 32, 280)];
        [panelImageView setImage:[UIImage imageNamed:@"bg_land.png"]];
        [sendButton setFrame:CGRectMake(361- 32 - 15 - 48, 13, 48, 30)];
        [titleLabel setCenter:CGPointMake(448 / 2, 27)];
    
        if (isKeyboardShowing)
        {
            [contentTextView setFrame:CGRectMake(13, 50, 361 - 32 - 26, 60)];
    ...
    {
        [self setFrame:CGRectMake(0, 0, 320, 361)];
        [panelView setFrame:CGRectMake(16, 43 - 10, 288, 335)];
        
        if(isKeyboardShowing)
        {
            [panelView setFrame:CGRectMake(16, 43 - 10 - 51, 288, 335)];
        }
...
#pragma mark - QWeiboSendView Public Methods
